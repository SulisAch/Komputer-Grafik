...
//  judul window
char *judul_window = "Komputer Grafik Algoritma Bresenham";
...
void init()
{
	glClearColor(0.1, 0.0, 0.1, 0.0); //set warna background 
	glColor3f(1.0, 1.0, 0.0); //set warna titik
	glPointSize(20.0); //set ukuran titik
